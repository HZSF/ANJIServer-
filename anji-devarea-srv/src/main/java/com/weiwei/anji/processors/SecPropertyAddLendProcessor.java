...
public class SecPropertyAddLendProcessor extends BaseProcessor {
	...
	protected void preProcess(Map scopes){
		...
		request = (PropertyAddLendRequest)scopes.get(Constants.SERVICE_REQUEST);
	...
	protected String executeProcess(Map scopes) {
		try{
			...
			propertyDao.insertLendProperty(username, region, category, property_area, levels, ask_price, description);
