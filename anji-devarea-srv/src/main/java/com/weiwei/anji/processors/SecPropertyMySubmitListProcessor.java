...
public class SecPropertyMySubmitListProcessor extends BaseProcessor{
	...
	protected String executeProcess(Map scopes) {
		...
		tableBeanList = (ArrayList<PropertyFavoriteJoinTable>)propertyDao.getMySubmitList(username);
		try{
