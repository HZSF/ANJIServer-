...
public class SecPropertyAddSellProcessor extends BaseProcessor {
	...
	protected void preProcess(Map scopes){
		...
		request = (PropertyAddSellRequest)scopes.get(Constants.SERVICE_REQUEST);
	...
	protected String executeProcess(Map scopes) {
		try{
			...
			propertyDao.insertSellProperty(username, region, category, property_area, levels, ask_price, description);
