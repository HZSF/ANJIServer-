...
public class SecPropertyFavoriteSellListProcessor extends BaseProcessor{
	...
	protected String executeProcess(Map scopes) {
		...
		if(moreComment){
			tableBeanList =  (ArrayList<PropertySellJoinTable>)propertyDao.getFavoriteSellListLimitedNumberStartFromId(username, request.getStartId(), numbers);
		}else{
			tableBeanList = (ArrayList<PropertySellJoinTable>)propertyDao.getFavoriteSellListLimitedNumber(username, numbers);
		}
		try{
