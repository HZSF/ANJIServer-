...
public class PropertyLendListProcessor extends BaseProcessor{
	...
	protected String executeProcess(Map scopes) {
		...
		if(moreComment){
			tableBeanList =  (ArrayList<PropertyLendJoinTable>)propertyDao.getLendingPropertyListLimitedNumberStartFromId(request.getStartId(), numbers);
		}else{
			tableBeanList = (ArrayList<PropertyLendJoinTable>)propertyDao.getLendingPropertyListLimitedNumber(numbers);
		}
		try{
